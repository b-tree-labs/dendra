...
Public entry points for ``postrule init --auto-lift``. Each lifter
consumes Python source plus a function name and returns refactored
source that targets the :class:`postrule.Switch` native authoring form.
...
def evidence_via_probe(**fields: str) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    ...
    def wrapper(fn: Callable[..., Any]) -> Callable[..., Any]:
        fn._postrule_evidence_probes = dict(fields)  # type: ignore[attr-defined]
        return fn
...
def evidence_inputs(
    **fields: Callable[..., Any],
    ...
    def wrapper(fn: Callable[..., Any]) -> Callable[..., Any]:
        fn._postrule_evidence_inputs = dict(fields)  # type: ignore[attr-defined]
        return fn
