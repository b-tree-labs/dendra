...
:class:`postrule.Switch` subclass in which each piece of hidden state
...
:func:`postrule.analyzer.analyze_function_source` for top-level functions
...
from postrule.analyzer import LiftStatus, analyze_function_source
...
# An attacker-supplied annotation cannot turn `postrule init --auto-lift`
