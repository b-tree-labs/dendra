...
Implements the experiment described in the Postrule paper §4.3:
...
from postrule.core import LearnedSwitch, Verdict
...
def train_ml_from_model_outcomes(
    ...
    **The LLM-as-teacher pattern.** When a switch has been running at
    ...
    Typical usage::
        ...
        from postrule import SklearnTextHead
...
def run_benchmark_experiment(
    *,
    ...
    ``ml_head`` must satisfy :class:`postrule.ml.MLHead`. The runner
    doesn't assume any particular backend — swap in a fake for tests.
    """
    from postrule.core import LearnedSwitch, Phase, SwitchConfig, Verdict
