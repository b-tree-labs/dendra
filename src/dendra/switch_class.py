...
constructs an inner :class:`~dendra.core.LearnedSwitch` lazily at
...
_BASE_MARKER = "__dendra_switch_base__"


class Switch:
    """Convention-driven base class for authoring a Dendra switch as a
    Python class.
    ...
    :class:`~dendra.core.LearnedSwitch` and proxy its public surface.
    """
